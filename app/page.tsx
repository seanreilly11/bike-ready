            ...
            <main className="min-h-screen bg-stone-50 overflow-x-hidden">
                ...
                <section className="bg-orange px-5 pt-12 pb-14 md:pt-20 md:pb-20">
                    <div className="max-w-2xl mx-auto">
                        ...
                        <p className="text-white/80 text-base md:text-lg leading-relaxed mb-6 max-w-lg">
                            A short preparation course for expats. 6 modules.
                            Real scenarios. The rules that actually trip people
                            up. Some shit about feeling confident and prepared.
                            Don't say what the product is. Say how it's gonna
                            make them feel or improve.
                        </p>
                ...
                <section className="bg-transparent border border-orange px-5 py-10 mx-5 mb-12 rounded-2xl max-w-5xl lg:mx-auto">
                    ...
                    <p className="text-orange/90 text-sm leading-relaxed max-w-lg">
                        Dutch cyclists learn this stuff as kids. You didn't.
                        BikeReady targets exactly the rules that differ from
                        what you already know — so you recalibrate fast and stay
                        safe.
                    </p>
                </section>
