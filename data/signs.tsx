...
function SignMandatoryCycle() {
  return (
    <svg
      ...
      aria-label="Mandatory cycle path (G11)"
    >
...
function SignPriorityRoad() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Priority road (voorrangsweg)"
    >
      {/* Yellow diamond */}
...
function SignUitgezonderd() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="No entry except cyclists (uitgezonderd fietsers)"
    >
      {/* Main no-entry sign */}
...
function SignCyclistLight() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Cyclist traffic light (red)"
    >
      {/* Light housing */}
...
function SignSharkTeeth() {
  return (
    <svg
      ...
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      aria-label="Shark teeth road marking (haaientanden)"
    >
      {/* Road surface */}
...
export const SIGN_REGISTRY = {
  ...
  motorized_only: MotorizedOnlySign, // TODO: add
  no_cycling: NoCyclingSign,
  no_parking: NoParkingSign, // TODO: add
